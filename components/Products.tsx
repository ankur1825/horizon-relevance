...
const PRODUCTS: Product[] = [
  {
    ...
    features: ["Real-Time Dashboards", "AI-powered Savings Recommendations", "Budget Guardrails", "Multi-Cloud Support", "Cloud Billing API integration"],
    useCases: [
      { industry: "FinTech", result: "Saved 37% on AWS within 2 weeks" },
      { industry: "Healthcare", result: "Reduced 40% infrastructure waste with AI scaling" },
    ],
  ...
  },
  {
    ...
    features: ["GitOps-ready pipeline integration", "Dynamic config loader", "Helm + Terraform modules", "Cost-aware deployments"],
    useCases: [
  ...
  },
  {
    ...
    features: ["Python-first Lambda deployment", "Event orchestration via Step Functions", "CloudWatch alerting and monitoring", "API Gateway with secure auto-docs", "Terraform & SAM support"],
    useCases: [
  ...
  },
  {
    ...
    features: ["Generative AI Alerting & RCA", "Anomaly Detection & Forecasting", "OpenTelemetry + Grafana Tempo integration", "CloudWatch metrics & Lambda triggers", "Slack + ServiceNow integration"],
    useCases: [
  ...
  },
  {
    ...
    features: ["No-code Jenkins pipeline creation", "GitHub webhook-based triggering", "Integrated SonarQube and OPA scanning", "LDAP-based access and audit trail", "Kubernetes-native deployment"],
    useCases: [
      { industry: "Healthcare", result: "3× faster developer deployments" },
      { industry: "Enterprise", result: "75% reduction in manual security reviews" },
    ],
